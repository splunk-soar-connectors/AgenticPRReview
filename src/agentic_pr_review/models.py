...
def normalize_finding(raw: dict[str, Any], *, default_source: str) -> dict[str, Any]:
    ...
    return {
        ...
        "offending_code": normalize_optional_text(raw.get("offending_code")),
        "primary_evidence": normalize_optional_text(raw.get("primary_evidence")),
        "supporting_evidence": normalize_optional_text(raw.get("supporting_evidence")),
        "base_evidence": normalize_optional_text(raw.get("base_evidence")),
        "evidence": str(raw.get("evidence") or "").strip(),
        "why_it_matters": str(raw.get("why_it_matters") or "").strip(),
        "suggested_fix": str(raw.get("suggested_fix") or "").strip(),
        "suggested_code": normalize_optional_text(raw.get("suggested_code") or raw.get("suggested_replacement")),
        "suggested_replacement": normalize_optional_text(raw.get("suggested_replacement")),
        ...
        "requires_global_verification": raw.get("requires_global_verification"),
        "verification_queries": raw.get("verification_queries"),
